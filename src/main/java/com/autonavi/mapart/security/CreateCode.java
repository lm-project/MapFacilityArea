...
//	      Graphics2D gd = buffImg.createGraphics();  
    	...
    	log.debug("----------------生成验证码并保存到session中："+randomCode.toString()); 
	...
	public @ResponseBody ResponseStatus getCode(HttpServletRequest request) {
		Object code = request.getSession().getAttribute("code");
		if (code == null) {
			return null;
		}
		log.debug("----------------code===="+code);
		return new ResponseStatus(100,"",code.toString());
	}
}
